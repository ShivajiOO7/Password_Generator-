...
public class Generator {
	...
	public static void requestPassword() {
		...
		while(true) {
	        ...
	        if (Input.equals("YES") || Input.equals("Yes") || Input.equals("yes") || Input.equals("y") || Input.equals("Y")) {
	        	...
	        	if (!(Input.equals("NO")) && (!Input.equals("No")) && (!Input.equals("no")) && (!Input.equals("n")) & (!Input.equals("N"))) {
			...
			if (Input.equals("YES") || Input.equals("Yes") || Input.equals("yes") || Input.equals("y") || Input.equals("Y")) {
	        	...
	        	if ((!Input.equals("NO")) && (!Input.equals("No")) && (Input.equals("no")==false && (!Input.equals("n")) & (!Input.equals("N")))) {
	        		PasswordRequestError();
	        		break;
	        	}
	        }
			...
			if (Input.equals("YES") || Input.equals("Yes") || Input.equals("yes") || Input.equals("y") || Input.equals("Y")) {
	        	...
	        	if ((!Input.equals("NO")) && (Input.equals("No")==false) && (Input.equals("no")==false)) {
	        		PasswordRequestError();
	        		break;
	        	}
	        }
	...
	public static void main(String[] args) {
		String Input;
		final Scanner in = new Scanner(System.in);
		System.out.println("Welcome to Anony Password Services :)" );
		printMenu();
